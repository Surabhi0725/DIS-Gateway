...
public interface UserDetailsService {
    ...
    ResponseEntity<?> authenticateUserFromMoodle(LoginForm loginRequest) throws NotFoundException;
    ...
    VerifyTokenResponse verifyToken(HttpServletRequest request);
    //UserDetails loadUserByUsername(String username) throws UsernameNotFoundException;
    ResponseEntity<ResponseMessage> registerNewUser(SignUpForm signUpRequest)  throws SQLException, MailConnectException, UnknownHostException;
